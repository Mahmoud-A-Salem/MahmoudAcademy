...
namespace MahmoudAcademy.Migrations
{
    ...
    [Migration("20250702150652_add-many-to-many-enrollments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MahmoudAcademy.Entities.SectionSchedule", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MahmoudAcademy.Entities.SectionSchedule", b =>
                {
                    b.HasOne("MahmoudAcademy.Entities.Schedule", null)
                        .WithMany("SectionSchedules")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MahmoudAcademy.Entities.Section", null)
                        .WithMany("SectionSchedules")
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
